...
const update_branch_dto_1 = require("../branch/dto/update-branch.dto");
...
let BranchController = exports.BranchController = class BranchController {
    constructor(branchService, attendantService) {
...
], BranchController.prototype, "fillAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
...
exports.BranchController = BranchController = __decorate([
    ...
    __param(1, (0, common_1.Inject)((0, common_1.forwardRef)(() => attendant_service_1.AttendantService))),
    __metadata("design:paramtypes", [branch_service_1.BranchService,
        attendant_service_1.AttendantService])
], BranchController);
